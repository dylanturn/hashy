...
if hash_type == "crc32":
    hashy_crc32.OpenCL_Hash(file_path=file_path, file_block_size=block_size, device_class=args.device_class, device_index=args.device_index, platform_index=args.device_platform).main()
else:
    exit()
